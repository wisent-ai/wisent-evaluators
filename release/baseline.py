...
downloads that artifact, and runs `release/surface.py` against the unpacked tree.
...
Usage:
    ...
    python3 release/baseline.py --cross-check 0.1.1  # sdist and wheel must agree
"""
...
def identity() -> tuple:
    ...
    tail = f"{entry['filename']} unpacked and read by release/surface.py"
